package org.hostile.anticheat.util.minecraft;
...
public class AxisAlignedBB {
    ...
    public AxisAlignedBB(CustomLocation customLocation) {
        this(customLocation.getX() - .3, customLocation.getY(), customLocation.getZ() - .3,
