...
import org.hostile.rogue.packet.inbound.*;
import org.hostile.rogue.packet.outbound.*;
...
public class PacketWrapper {
    ...
    static {
        ...
        PACKET_MAP.put(PacketType.Play.Client.KEEP_ALIVE, getConstructor(WrappedPacketPlayInKeepAlive.class));
